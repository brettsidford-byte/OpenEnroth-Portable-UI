...
enum class InputActionContext { None, Gameplay, Character, GameMenu, Dialogue, RestTransition, PartyCreation, System, Arcomage };
...
inline constexpr std::array<InputActionPage, 10> kInputActionPages = {{
    ...
    {"DIALOGUE", InputActionContext::Dialogue, {INPUT_ACTION_DIALOG_UP, INPUT_ACTION_DIALOG_DOWN, INPUT_ACTION_DIALOG_LEFT, INPUT_ACTION_DIALOG_RIGHT, INPUT_ACTION_DIALOG_PRESS, INPUT_ACTION_ESCAPE}, 6},
    ...
    {"SYSTEM", InputActionContext::System, {INPUT_ACTION_TAKE_SCREENSHOT, INPUT_ACTION_OPEN_CONSOLE, INPUT_ACTION_TOGGLE_WINDOW_MODE}, 3},
